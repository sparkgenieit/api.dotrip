...
-- AlterTable
ALTER TABLE `address_books` ADD COLUMN `address` VARCHAR(191) NULL,
    MODIFY `type` ENUM('HOME', 'OFFICE', 'OTHER', 'PICKUP', 'DROP') NOT NULL,
    MODIFY `addressLine1` VARCHAR(191) NULL,
    MODIFY `buildingName` VARCHAR(191) NULL,
