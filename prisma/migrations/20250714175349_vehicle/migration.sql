...
-- AlterTable
ALTER TABLE `vehicle` ADD COLUMN `createdBy` ENUM('RIDER', 'VENDOR', 'DRIVER', 'ADMIN', 'SUPPORT_AGENT', 'SUPER_ADMIN') NOT NULL DEFAULT 'VENDOR',
    ADD COLUMN `driverOwnerId` INTEGER NULL;
