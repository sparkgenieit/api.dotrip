...
AuthModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            jwt_1.JwtModule.register({ secret: constants_1.jwtConstants.secret, signOptions: { expiresIn: '15m' } }),
            jwt_1.JwtModule.register({ secret: constants_1.jwtConstants.refreshSecret, signOptions: { expiresIn: '7d' } }),
        ],
